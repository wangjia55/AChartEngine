...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
    ...
    /**
     * 为了扩展功能而增加的属性 added by cvte.wangjia
     */
    private float targetValue = 0;  //制定目标线

    private int targetLineColor = Color.BLUE;  //目标线的颜色

    private boolean targetLineVisible = false;   //目标线是否可见

    private SupportTargetLineStyle targetLineStyle = SupportTargetLineStyle.Line_Solid;  //目标线样式

    private String targetDescription = "";   //目标的文字描述

    private SupportXAlign supportXAlign = SupportXAlign.CENTER;   //横坐标轴title的位置

    private SupportYAlign supportYAlign = SupportYAlign.CENTER;   //纵坐标轴title的位置

    private boolean colorRampVisible = false;   //是否支持Y轴边上的颜色渐变色带
    ...
    public void setTargetLineColor(int targetLineColor) {
        this.targetLineColor = targetLineColor;
    }

    public boolean isTargetLineVisible() {
        return targetLineVisible;
    }

    public void setTargetLineVisible(boolean targetLineVisible) {
        this.targetLineVisible = targetLineVisible;
    }

    public SupportTargetLineStyle getTargetLineStyle() {
        return targetLineStyle;
    }

    public void setTargetLineStyle(SupportTargetLineStyle targetLineStyle) {
        this.targetLineStyle = targetLineStyle;
    }
    ...
    public SupportXAlign getSupportXAlign() {
        return supportXAlign;
    }

    public void setSupportXAlign(SupportXAlign supportXAlign) {
        this.supportXAlign = supportXAlign;
    }

    public SupportYAlign getSupportYAlign() {
        return supportYAlign;
    }

    public void setSupportYAlign(SupportYAlign supportYAlign) {
        this.supportYAlign = supportYAlign;
    }

    public boolean isColorRampVisible() {
        return colorRampVisible;
    }

    public void setColorRampVisible(boolean colorRampVisible) {
        this.colorRampVisible = colorRampVisible;
    }

    public float getColorRampWidth() {
        return colorRampWidth;
    }

    public void setColorRampWidth(float colorRampWidth) {
        this.colorRampWidth = colorRampWidth;
    }

    public float[] getColorRampGradientPosition() {
        return colorRampGradientPosition;
    }

    public void setColorRampGradientPosition(float[] colorRampGradientPosition) {
        this.colorRampGradientPosition = colorRampGradientPosition;
    }

    public int[] getColorRampGradient() {
        return colorRampGradient;
    }

    public void setColorRampGradient(int[] colorRampGradient) {
        this.colorRampGradient = colorRampGradient;
    }
}
